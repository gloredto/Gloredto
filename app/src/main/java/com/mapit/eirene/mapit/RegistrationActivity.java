...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void sendUserData(){
        ...
        final double userLongitude, userLatitude;
        final String userQuote;
        userLatitude = -6.891284 ;
        userLongitude = 107.6196;
        userQuote = "newUser";
        UserStatus userStatusPosition = new UserStatus(userLatitude, userLongitude);
        myRef.child("Status").child("Position").setValue(userStatusPosition);
        UserStatus userStatusQuote = new UserStatus(userQuote);
